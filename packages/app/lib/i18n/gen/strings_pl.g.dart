...
// Path: theme
class _Translations$theme$pl extends Translations$theme$en {
	_Translations$theme$pl._(TranslationsPl root) : this._root = root, super.internal(root);

	final TranslationsPl _root; // ignore: unused_field

	// Translations
	@override String get switchToLight => 'Przełącz na jasny motyw';
	@override String get switchToDark => 'Przełącz na ciemny motyw';
	@override String get openNostr => 'Otwórz profil Nostr';
}
...
class _Translations$notificationSettings$pl extends Translations$notificationSettings$en {
	...
	@override late final _Translations$notificationSettings$activeOfferAlerts$pl activeOfferAlerts = _Translations$notificationSettings$activeOfferAlerts$pl._(_root);
}
...
class _Translations$altstore$pl extends Translations$altstore$en {
	...
	@override String approvalNotice({required Object app, required Object paymentSystem}) => '${app} czeka na zatwierdzenie przez Apple dla iOS. W międzyczasie zainstaluj BitBlik: ten sam kod obsługuje ${paymentSystem}. Zmień kraj/system płatności w Ustawieniach.';
}
...
class _Translations$twint$shop$pl extends Translations$twint$shop$en {
	...
	@override String get importImage => 'Importuj obraz QR';
	@override String get imageFailed => 'Nie udało się odczytać obsługiwanego sklepowego kodu QR CHF z tego obrazu. Wybierz inny obraz.';
...
class _Translations$twint$scanner$pl extends Translations$twint$scanner$en {
	...
	@override String get importImage => 'Importuj zrzut ekranu';
...
class _Translations$notificationSettings$activeOfferAlerts$pl extends Translations$notificationSettings$activeOfferAlerts$en {
	_Translations$notificationSettings$activeOfferAlerts$pl._(TranslationsPl root) : this._root = root, super.internal(root);

	final TranslationsPl _root; // ignore: unused_field

	// Translations
	@override String get label => 'Alerty aktywnej oferty';
	@override String description({required Object app}) => 'Po włączeniu ${app} powiadomi Cię o zmianie statusu aktywnej oferty. Usługa w tle działa tylko, gdy masz aktywną ofertę.';
}
...
class _Translations$taker$waitConfirmation$expiredActions$pl extends Translations$taker$waitConfirmation$expiredActions$en {
	...
	// Translations
	@override String get checkReportStatus => 'Sprawdź status / ponów zgłoszenie';
}
...
class _Translations$taker$waitConfirmation$feedback$pl extends Translations$taker$waitConfirmation$feedback$en {
	...
	// Translations
	@override String get chargeReported => 'Zgłoszenie obciążenia przyjęte. Oczekiwanie na odpowiedź Makera lub automatyczne potwierdzenie.';
}
...
class _Translations$taker$waitConfirmation$errors$pl extends Translations$taker$waitConfirmation$errors$en {
	...
	// Translations
	@override String get reportingConflictUnconfirmed => 'Oczekiwanie na potwierdzenie zgłoszenia. Nie wiadomo, czy dotarło. Sprawdź status, aby ponowić zgłoszenie, jeśli nadal jest potrzebne. Jeśli status pozostaje niedostępny, skontaktuj się z pomocą.';
}
...
class _Translations$twint$scanner$status$pl extends Translations$twint$scanner$status$en {
	...
	@override String get imageFailed => 'Nie udało się znaleźć kodu TWINT ani kwoty CHF na tym zrzucie ekranu. Wybierz inny obraz.';
}
...
extension on TranslationsPl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'taker.waitConfirmation.expiredActions.checkReportStatus' => 'Sprawdź status / ponów zgłoszenie',
			'taker.waitConfirmation.feedback.chargeReported' => 'Zgłoszenie obciążenia przyjęte. Oczekiwanie na odpowiedź Makera lub automatyczne potwierdzenie.',
			'taker.waitConfirmation.errors.reportingConflictUnconfirmed' => 'Oczekiwanie na potwierdzenie zgłoszenia. Nie wiadomo, czy dotarło. Sprawdź status, aby ponowić zgłoszenie, jeśli nadal jest potrzebne. Jeśli status pozostaje niedostępny, skontaktuj się z pomocą.',
			...
			'twint.scanner.importImage' => 'Importuj zrzut ekranu',
			...
			'twint.scanner.status.imageFailed' => 'Nie udało się znaleźć kodu TWINT ani kwoty CHF na tym zrzucie ekranu. Wybierz inny obraz.',
			...
			'notificationSettings.activeOfferAlerts.label' => 'Alerty aktywnej oferty',
			'notificationSettings.activeOfferAlerts.description' => ({required Object app}) => 'Po włączeniu ${app} powiadomi Cię o zmianie statusu aktywnej oferty. Usługa w tle działa tylko, gdy masz aktywną ofertę.',
			...
			'altstore.approvalNotice' => ({required Object app, required Object paymentSystem}) => '${app} czeka na zatwierdzenie przez Apple dla iOS. W międzyczasie zainstaluj BitBlik: ten sam kod obsługuje ${paymentSystem}. Zmień kraj/system płatności w Ustawieniach.',
			_ => null,
		};
	}
}
