...
class TranslationsIt extends Translations {
	...
	@override late final _TranslationsOfferNotificationsIt offerNotifications = _TranslationsOfferNotificationsIt._(_root);
...
class _TranslationsOfferNotificationsIt extends TranslationsOfferNotificationsEn {
	_TranslationsOfferNotificationsIt._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override late final _TranslationsOfferNotificationsActiveServiceIt activeService = _TranslationsOfferNotificationsActiveServiceIt._(_root);
	...
	@override late final _TranslationsOfferNotificationsTakerPaidIt takerPaid = _TranslationsOfferNotificationsTakerPaidIt._(_root);
}
...
class _TranslationsOffersDetailsIt extends TranslationsOffersDetailsEn {
	...
	@override late final _TranslationsOffersDetailsCategoriesIt categories = _TranslationsOffersDetailsCategoriesIt._(_root);
	@override late final _TranslationsOffersDetailsConsentsIt consents = _TranslationsOffersDetailsConsentsIt._(_root);
}
...
class _TranslationsTakerWaitConfirmationIt extends TranslationsTakerWaitConfirmationEn {
	...
	@override late final _TranslationsTakerWaitConfirmationCategoryReminderIt categoryReminder = _TranslationsTakerWaitConfirmationCategoryReminderIt._(_root);
...
class _TranslationsTakerPaymentFailedIt extends TranslationsTakerPaymentFailedEn {
	...
	@override late final _TranslationsTakerPaymentFailedWalletSectionIt walletSection = _TranslationsTakerPaymentFailedWalletSectionIt._(_root);
...
class _TranslationsOfferNotificationsActiveServiceIt extends TranslationsOfferNotificationsActiveServiceEn {
	_TranslationsOfferNotificationsActiveServiceIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOfferNotificationsFundedIt extends TranslationsOfferNotificationsFundedEn {
	_TranslationsOfferNotificationsFundedIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOfferNotificationsReservedIt extends TranslationsOfferNotificationsReservedEn {
	_TranslationsOfferNotificationsReservedIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOfferNotificationsBlikReadyIt extends TranslationsOfferNotificationsBlikReadyEn {
	_TranslationsOfferNotificationsBlikReadyIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOfferNotificationsBlikPendingReminderIt extends TranslationsOfferNotificationsBlikPendingReminderEn {
	_TranslationsOfferNotificationsBlikPendingReminderIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOfferNotificationsTakerChargedIt extends TranslationsOfferNotificationsTakerChargedEn {
	_TranslationsOfferNotificationsTakerChargedIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOfferNotificationsInvalidBlikIt extends TranslationsOfferNotificationsInvalidBlikEn {
	_TranslationsOfferNotificationsInvalidBlikIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOfferNotificationsTakerPaidIt extends TranslationsOfferNotificationsTakerPaidEn {
	_TranslationsOfferNotificationsTakerPaidIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOffersDetailsCategoriesIt extends TranslationsOffersDetailsCategoriesEn {
	_TranslationsOffersDetailsCategoriesIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsOffersDetailsConsentsIt extends TranslationsOffersDetailsConsentsEn {
	_TranslationsOffersDetailsConsentsIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsMakerAmountFormCategoryIt extends TranslationsMakerAmountFormCategoryEn {
	_TranslationsMakerAmountFormCategoryIt._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsMakerAmountFormCategoryShortLabelsIt shortLabels = _TranslationsMakerAmountFormCategoryShortLabelsIt._(_root);
...
class _TranslationsTakerWaitConfirmationCategoryReminderIt extends TranslationsTakerWaitConfirmationCategoryReminderEn {
	_TranslationsTakerWaitConfirmationCategoryReminderIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsTakerPaymentFailedWalletSectionIt extends TranslationsTakerPaymentFailedWalletSectionEn {
	_TranslationsTakerPaymentFailedWalletSectionIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsMakerAmountFormCategoryOptionsIt extends TranslationsMakerAmountFormCategoryOptionsEn {
	_TranslationsMakerAmountFormCategoryOptionsIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsMakerAmountFormCategoryShortLabelsIt extends TranslationsMakerAmountFormCategoryShortLabelsEn {
	_TranslationsMakerAmountFormCategoryShortLabelsIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'offers.errors.atmConsentRequired': return 'Accetta la condizione sulla commissione ATM prima di prendere questa offerta.';
			case 'offers.errors.ecommerceConsentRequired': return 'Accetta la condizione di restituzione del rimborso ecommerce prima di prendere questa offerta.';
			...
			case 'coordinator.management.coordinatorAddInfoUnavailable': return 'Nessuna informazione sul coordinatore trovata sui relay. Coordinatore non aggiunto.';
			case 'coordinator.management.pleaseEnterNpub': return 'Inserisci un npub';
			case 'coordinator.management.error': return 'Errore';
			case 'coordinator.management.metricYourOffers': return 'Le tue offerte';
			case 'coordinator.management.metricYourOffersTooltip': return 'Numero di offerte che hai completato con successo con questo coordinatore.';
			case 'coordinator.management.metricNetworkOffers': return 'Offerte (30g)';
			case 'coordinator.management.metricNetworkOffersTooltip': return 'Offerte risolte con successo da questo coordinatore tra tutti gli utenti negli ultimi 30 giorni.';
			...
			case 'maker.amountForm.labels.category': return 'Categoria';
			...
			case 'maker.amountForm.category.shortLabels.shop': return 'Negozio';
			...
			case 'maker.amountForm.errors.categoryRequired': return 'Seleziona una categoria per l\'offerta.';
			case 'maker.amountForm.errors.ecommerceConfirmationRequired': return 'Conferma il rischio di rimborso del negozio online prima di continuare.';
			...
			case 'maker.waitTaker.offerExpiredTitle': return 'Offerta scaduta';
			case 'maker.waitTaker.offerExpiredMessage': return 'Nessun taker ha riservato la tua offerta in tempo.';
			case 'maker.waitTaker.recreateOffer': return 'Nuova offerta — stesso importo';
			...
			case 'taker.waitConfirmation.categoryReminder.atm': return 'Promemoria offerta ATM: la tua banca potrebbe ancora chiederti di approvare una commissione ATM extra oltre all\'importo principale.';
			case 'taker.waitConfirmation.categoryReminder.ecommerce': return 'Promemoria ordine online: se il commerciante invia un rimborso automatico al tuo conto bancario, contatta il coordinatore e restituiscilo.';
			...
			case 'taker.paymentFailed.errors.generateFailed': return ({required Object details}) => 'Impossibile generare la fattura: ${details}';
			case 'taker.paymentFailed.walletSection.title': return 'Genera fattura dal portafoglio';
			case 'taker.paymentFailed.walletSection.defaultLabel': return 'predefinito';
			case 'taker.paymentFailed.walletSection.tapToGenerate': return ({required Object amountSats}) => 'Tocca per generare la fattura per ${amountSats} sats';
			...
			case 'nwc.labels.scanQrCode': return 'Scansiona il codice QR con la tua connessione NWC';
			...
			case 'offerNotifications.takerCharged.body': return 'Il taker segnala che il BLIK è stato addebitato. Conferma o segna come non valido.';
			case 'offerNotifications.invalidBlik.title': return 'BLIK non valido';
			case 'offerNotifications.invalidBlik.body': return 'Il maker ha contrassegnato il tuo codice BLIK come non valido.';
			case 'offerNotifications.takerPaid.title': return 'Pagamento ricevuto';
			case 'offerNotifications.takerPaid.body': return 'Il tuo pagamento Lightning è stato inviato.';
