...
class _Translations$twint$it extends Translations$twint$en {
	...
	// Translations
	@override late final _Translations$twint$shop$it shop = _Translations$twint$shop$it._(_root);
...
class _Translations$notificationSettings$it extends Translations$notificationSettings$en {
	...
	@override late final _Translations$notificationSettings$activeOfferAlerts$it activeOfferAlerts = _Translations$notificationSettings$activeOfferAlerts$it._(_root);
}
...
class _Translations$offerNotifications$it extends Translations$offerNotifications$en {
	...
	@override late final _Translations$offerNotifications$activeOfferService$it activeOfferService = _Translations$offerNotifications$activeOfferService$it._(_root);
...
class _Translations$altstore$it extends Translations$altstore$en {
	...
	@override String approvalNotice({required Object app, required Object paymentSystem}) => '${app} è in attesa dell\'approvazione iOS di Apple. Nel frattempo, installa BitBlik: stesso codice, supporta ${paymentSystem}. Cambia paese/sistema di pagamento nelle Impostazioni.';
}
...
// Path: twint.shop
class _Translations$twint$shop$it extends Translations$twint$shop$en {
	_Translations$twint$shop$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get scanTitle => 'Scansiona il QR del negozio';
	@override String get scanInstructions => 'Scansiona il codice QR di pagamento sul terminale del negozio. L’importo in CHF verrà letto dal codice.';
	@override String get invalidQr => 'Questo codice QR non è un pagamento in negozio in CHF supportato. Scansiona il codice QR di pagamento sul terminale.';
	@override String get amountMismatch => 'Questo codice QR ha un importo diverso. Richiedi un nuovo codice QR con l’importo originale del pagamento.';
	@override String get cameraFailed => 'Fotocamera non disponibile. Consenti l’accesso alla fotocamera nelle impostazioni del dispositivo o del browser, poi riprova.';
	@override String get importImage => 'Importa immagine QR';
	@override String get imageFailed => 'Impossibile leggere un QR di negozio CHF supportato da questa immagine. Scegli un’altra immagine.';
	@override String get scanned => 'QR del negozio scansionato. Controlla l’importo in CHF prima di finanziare l’offerta.';
	@override String get rescan => 'Scansiona un altro codice QR';
	@override String get coordinatorUnsupported => 'Questo coordinatore non supporta i pagamenti QR in negozio. Scegli un coordinatore che li supporti.';
	@override String get loadingFailed => 'Impossibile caricare il codice QR di pagamento. Riprova.';
	@override String get replacementInstructions => 'Scansiona un nuovo codice QR del negozio con lo stesso importo in CHF dell’offerta finanziata.';
	@override String get replacementScanned => 'Il QR sostitutivo corrisponde all’importo finanziato.';
	@override String get qrLabel => 'Codice QR di pagamento TWINT';
	@override String get payInstructions => 'Scansiona questo codice QR con TWINT oppure salva l’immagine e importala dalla tua galleria in TWINT. Controlla l’esercente e l’importo prima di pagare.';
	@override String get saveImage => 'Salva il QR nelle foto';
	@override String get downloadImage => 'Scarica l’immagine QR';
	@override String get saving => 'Salvataggio dell’immagine QR…';
	@override String get saved => 'Immagine QR salvata. Apri TWINT e importala dalla tua galleria.';
	@override String get downloadStarted => 'Download dell’immagine QR avviato. Salvala nelle tue foto per importarla in TWINT.';
	@override String get saveFailed => 'Impossibile salvare l’immagine QR. Controlla le autorizzazioni per le foto e lo spazio di archiviazione disponibile, poi riprova.';
	@override String get expired => 'Questo codice QR è scaduto. Non pagarlo e non usare un’immagine salvata in precedenza.';
}
...
class _Translations$twint$scanner$it extends Translations$twint$scanner$en {
	...
	@override String get importImage => 'Importa schermata';
...
class _Translations$notificationSettings$activeOfferAlerts$it extends Translations$notificationSettings$activeOfferAlerts$en {
	_Translations$notificationSettings$activeOfferAlerts$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get label => 'Avvisi offerta attiva';
	@override String description({required Object app}) => 'Se abilitato, ${app} ti avviserà quando lo stato della tua offerta attiva cambia. Il servizio in background resta attivo solo finché hai un\'offerta attiva.';
}
...
class _Translations$offerNotifications$activeOfferService$it extends Translations$offerNotifications$activeOfferService$en {
	_Translations$offerNotifications$activeOfferService$it._(TranslationsIt root) : this._root = root, super.internal(root);

	final TranslationsIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Monitoraggio offerta attiva';
	@override String body({required Object app}) => 'Il servizio Nostr monitora gli aggiornamenti della tua offerta ${app} attiva.';
}
...
class _Translations$twint$scanner$status$it extends Translations$twint$scanner$status$en {
	...
	@override String get imageFailed => 'Impossibile trovare un codice TWINT o importo CHF in questa schermata. Scegli un’altra immagine.';
}
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'twint.shop.saveImage' => 'Salva il QR nelle foto',
			'twint.shop.downloadImage' => 'Scarica l’immagine QR',
			'twint.shop.saving' => 'Salvataggio dell’immagine QR…',
			'twint.shop.saved' => 'Immagine QR salvata. Apri TWINT e importala dalla tua galleria.',
			'twint.shop.downloadStarted' => 'Download dell’immagine QR avviato. Salvala nelle tue foto per importarla in TWINT.',
			'twint.shop.saveFailed' => 'Impossibile salvare l’immagine QR. Controlla le autorizzazioni per le foto e lo spazio di archiviazione disponibile, poi riprova.',
			'twint.shop.expired' => 'Questo codice QR è scaduto. Non pagarlo e non usare un’immagine salvata in precedenza.',
			'twint.scanner.title' => ({required Object code}) => 'Scansiona codice ${code}',
			'twint.scanner.importImage' => 'Importa schermata',
			...
			'twint.scanner.status.imageFailed' => 'Impossibile trovare un codice TWINT o importo CHF in questa schermata. Scegli un’altra immagine.',
			...
			'notificationSettings.activeOfferAlerts.label' => 'Avvisi offerta attiva',
			'notificationSettings.activeOfferAlerts.description' => ({required Object app}) => 'Se abilitato, ${app} ti avviserà quando lo stato della tua offerta attiva cambia. Il servizio in background resta attivo solo finché hai un\'offerta attiva.',
			...
			'offerNotifications.activeOfferService.title' => 'Monitoraggio offerta attiva',
			'offerNotifications.activeOfferService.body' => ({required Object app}) => 'Il servizio Nostr monitora gli aggiornamenti della tua offerta ${app} attiva.',
			...
			'altstore.approvalNotice' => ({required Object app, required Object paymentSystem}) => '${app} è in attesa dell\'approvazione iOS di Apple. Nel frattempo, installa BitBlik: stesso codice, supporta ${paymentSystem}. Cambia paese/sistema di pagamento nelle Impostazioni.',
			_ => null,
		};
	}
}
